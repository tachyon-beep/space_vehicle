...
now owe. `check_vehicle.py` does that for the *definition* — it reports 254 declared debts by
...
def load_world(root: Path) -> World:
    ...
    return World(
        ...
        # the linter reports 254 declared debts, most of which are prose obligations ("this needs a
