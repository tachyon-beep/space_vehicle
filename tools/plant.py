...
now owe. `check_vehicle.py` does that for the *definition* — it reports 293 declared debts by
...
def load_world(root: Path) -> World:
    ...
    return World(
        ...
        # the linter reports 293 declared debts, most of which are prose obligations ("this needs a
