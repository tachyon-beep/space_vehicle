...
now owe. `check_vehicle.py` does that for the *definition* — it reports 276 declared debts by
...
def load_world(root: Path) -> World:
    ...
    world = World(
        ...
        # the linter reports 276 declared debts, most of which are prose obligations ("this needs a
