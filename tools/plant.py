...
now owe. `check_vehicle.py` does that for the *definition* — it reports 292 declared debts by
...
def load_world(root: Path) -> World:
    ...
    return World(
        ...
        # the linter reports 292 declared debts, most of which are prose obligations ("this needs a
